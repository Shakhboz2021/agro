   ...
   if(isset($_SESSION['staff_login'])) 
         {
              $staff_login=$_SESSION['staff_login'];      
                                ...
                                $query = "CALL `getVilSvod`()";  // getQaror - procedure 1 
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Вилоятлар рўйхати</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Бош</a></li>
                        <li class="breadcrumb-item active">Вилоятлар</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><center><b>Республикада фаолият кўрсатаётган кўп тармоқли фермер хўжаликлари</b></center></h4>
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <table id="exportTableExcel"    class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2" style="vertical-align:middle;">Вилоятлар</th>
                     ...
                     while($row = mysqli_fetch_array($search_viloyat_svod))
                            {  ?>
                                        <tr>
                                                <td><?php echo $t;?></td>
                                                <td><a href="district_t.php?vil_id=<?php echo $row['auto_id'];?>"><?php echo $row['viloyat'];?></a></td>
                                                <td><?php 
                                                if(empty($row[2]))
                                                    {
                                                       echo ''; 
